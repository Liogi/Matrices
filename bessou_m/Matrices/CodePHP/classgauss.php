...
class Gauss extends Matrice{
	...
	function calcul_G1(){
		for ($i = 1; $i < count($this->matriceA); ++$i){
			...
			{
				echo "<div>Division par 0 impossible, pas de solutions pour ce système. <br/></div>";
				exit(0);
			}
	...
	function operation(){
		...
		{	
			if ($this->matriceA2[1][0] == 0 && $this->matriceA2[1][1] != 0 && $this->matriceA2[0][0] != 0)
			{
		...
		{
			if (($this->matriceA3[2][0] == 0 && $this->matriceA3[2][1] == 0) && $this->matriceA3[2][2] != 0 && $this->matriceA3[1][1] != 0)
			{
		...
		else if (count($this->matriceA) == 4)
		{
			if (($this->matriceA4[3][0] == 0 && $this->matriceA4[3][1] == 0) && $this->matriceA4[3][2] == 0 
				&& $this->matriceA4[3][3] != 0 && $this->matriceA4[2][2] != 0 && $this->matriceA4[1][1] != 0 && $this->matriceA4[0][0] != 0)
			{
